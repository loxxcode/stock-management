...
import { DollarSign, Package, TrendingUp, AlertTriangle, ShoppingCart, ArrowDownRight, HandCoins, Eye, EyeOff, Users, Warehouse, BarChart3 } from "lucide-react";
  ...
  return (
    <div className="pb-24">
      <PageHeader 
        ...
        subtitle="Business overview and stock management" 
        showNotification 
      />

      <div className="px-4 space-y-4 mt-2">
        {/* Manager Overview Banner */}
        <div className="rounded-2xl border border-primary/20 bg-primary/5 p-4">
          <div className="flex items-center gap-2 text-primary">
            <BarChart3 className="h-4 w-4" />
            <span className="text-xs font-semibold uppercase tracking-[0.2em]">Business Overview</span>
          </div>
          <div className="mt-3 flex items-center justify-between gap-3">
            <div>
              <p className="text-lg font-bold text-foreground">Stock Management</p>
              <p className="text-xs text-muted-foreground">
                Monitor inventory, sales, and financial performance
              </p>
            </div>
        ...
        <div className="rounded-xl border border-border bg-card p-4">
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <button className="flex flex-col items-center gap-2 p-4 rounded-xl bg-secondary hover:bg-secondary/80 transition-colors">
              ...
              <span className="text-sm font-medium text-foreground">Stock In</span>
            </button>
          </div>
        </div>
      </div>
